...
public class RegressionSuiteRunner_Grid {
	public static void main(String[] args) throws Exception {
		...
		String nodes = "http://192.168.0.30:5566/wd/hub,http://192.168.0.34:5588/wd/hub";
		nodes = "http://192.168.0.30:5566/wd/hub";

		args = new String[] { "-TLD", "http://newtours.demoaut.com", "-TTR", "1", "-NT", "2", "-SPF", "Windows",
				"-suites", "RegressionSuite", "-NS", nodes };
